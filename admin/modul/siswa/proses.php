...
if (isset($_POST['saveSiswa'])) {
		...
		if ($pindah) {
		$save= mysqli_query($con,"INSERT INTO tb_siswa VALUES(NULL,'$_POST[npm]','$_POST[nama]','$_POST[tempat]','$_POST[tgl]','$_POST[jk]','$_POST[alamat]','$pass','$nama_gambar','1','$_POST[th_masuk]','$_POST[kelas]') ");
			if ($save) {
					echo "
